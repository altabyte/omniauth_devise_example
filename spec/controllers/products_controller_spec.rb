...
RSpec.describe ProductsController, type: :controller do
  ...
  context 'not signed in' do
    it { redirects_to_login_page_when_not_authenticated(:new) }
    it { redirects_to_login_page_when_not_authenticated(:create) }
    it { redirects_to_login_page_when_not_authenticated(:edit, { id: FactoryGirl.create(:product).to_param }) }
  end
  ...
  context 'Signed in' do
    ...
    let(:invalid_attributes) {
      FactoryGirl.attributes_for(:product, name: nil, price: nil)
    }
